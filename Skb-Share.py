...
def login():
	os.system("clear")
	cetak(nel(f'   {P2}Login Cookies Terlebih Dahulu Bro\n\n              {H2}--[ FERLY XD ]--',title=f'{P2} {H2}[ {P2}Selamat Datang Semoga Suka {H2}]',width=54,padding=(1,4),style='blue'))
